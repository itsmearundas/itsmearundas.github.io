...
export const projects = [
  ...
  },
  {
    ...
    shortTitle: 'PDFForge',
    tagline: 'Merge, split, compress, convert, protect and sign PDFs — 100% free, private, and processed entirely in your browser.',
    description:
      'A full PDF toolkit covering every common document task — JPG-to-PDF, PDF-to-JPG, merge, split & extract, organize, rotate, compress, watermark, page numbers, e-sign, password protect/unlock, and PDF-to-Word — with zero file uploads. Every operation runs client-side, so files never leave the user\'s device, with no ads, watermarks, or sign-up required.',
    period: '2026',
    ...
    features: [
      '12 tools in one app: merge, split/extract, organize, rotate, compress, watermark, page numbers, sign, protect/unlock, JPG↔PDF, PDF-to-Word',
      '100% client-side processing — no file ever touches a server',
      'Drag-and-drop reordering for merge, split, and page organization',
      'Draw or type e-signatures and place them anywhere on the page',
      'Password protection using industry-standard PDF encryption',
      'Adjustable compression levels for scanned or image-heavy PDFs',
    ],
    results: [
  ...
  },
  {
    ...
    shortTitle: 'VaultLock',
    tagline: 'A private Windows vault that encrypts files, folders, and their names — with decoy vaults and a silent panic wipe.',
    description:
      'A Windows desktop vault for files you\'d rather keep off the visible desktop. Every file is AES-256-CTR + HMAC-SHA256 encrypted before it touches the vault, and file/folder names become random tokens on disk — the real names live only in an encrypted manifest. A second password opens a separate decoy vault; a third silently wipes the real vault with no visible trace.',
    period: '2026',
    ...
    features: [
      'Every file encrypted at rest with AES-256-CTR + HMAC-SHA256',
      'File and folder names randomized on disk, real names kept in an encrypted manifest',
      'Decoy vault password opens a separate, independently-keyed vault',
      'Panic-wipe password silently destroys the real vault with no error shown',
      'Vault can live on any drive — internal, external SSD, or NAS mount',
      'No password recovery by design — zero-knowledge security model',
    ],
    results: [
      { value: 'AES-256', label: 'Encryption' },
      { value: '3', label: 'Password Modes' },
      { value: 'Zero', label: 'Recovery Backdoor' },
    ],
    color: 'purple',
    gradClass: 'purple',
  },
  {
    ...
    shortTitle: 'TypeForge',
    tagline: 'A real-time typing trainer tracking WPM, accuracy, and consistency across timed sessions.',
    description:
      'A precision typing trainer with selectable session lengths (15s–120s), custom text input, and live WPM/accuracy/mistake tracking as you type. Every session is logged to a history table and charted on a WPM-over-time graph, with a running best-WPM record and a session summary sheet at the end of each run.',
    period: '2026',
    ...
    features: [
      'Real-time WPM, accuracy, and mistake tracking while typing',
      'Selectable timed sessions: 15s, 30s, 60s, 120s',
      'Custom text mode for practicing specific passages',
      'Session history table with recent runs and a running best-WPM record',
      'WPM-over-time chart and consistency scoring per session',
    ],
    results: [
      { value: 'Live', label: 'WPM Tracking' },
      { value: '4', label: 'Timed Modes' },
      { value: 'Session', label: 'History + Charts' },
    ],
    color: 'mint',
    gradClass: 'mint',
  },
